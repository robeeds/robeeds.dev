...
export interface Page {
  ...
  title: string;
  hero: {
    type: 'none' | 'highImpact' | 'mediumImpact' | 'lowImpact' | 'horizontal' | 'retroHero';
    richText?: {
      root: {
        type: string;
        children: {
...
export interface FeaturesBlock {
  ...
  rows?:
    | {
        feature: {
          textWidth?: ('oneThird' | 'half' | 'twoThirds' | 'full') | null;
          richText: {
            root: {
              type: string;
              children: {
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        feature?: T | FeaturesBlockSelect<T>;
...
export interface CodeBlock {
  language?: ('typescript' | 'javascript' | 'css' | 'shell' | 'markdown') | null;
  code: string;
  id?: string | null;
  blockName?: string | null;
  blockType: 'code';
